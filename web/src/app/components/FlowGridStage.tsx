...
/**
 * Stage shell for the pool-grid view — same lens/mast and below-fold copy
 * as the main Tornado flow stage. Canvas is FlowPoolGrid, not FlowViz.
 */
export default function FlowGridStage({ snapshots }: Props) {
